...
--
-- Struktur dari tabel `impian`
--

CREATE TABLE `impian` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nama_impian` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `harapan_tercapai` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_impian` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `impian`
--
...
(3, '2020_03_11_004704_create_impian_table', 2);
