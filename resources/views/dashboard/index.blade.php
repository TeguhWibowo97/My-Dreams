...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="/assetAdmin/img/favicon.png" type="image/png" />
    <title>Home</title>
    <!-- Bootstrap CSS -->
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">Data Pencapaian</h2>
              <p>
                Gapailah semua impianmu terus maju dan pantang menyerah
              </p>
            </div>
          </div>
        </div>
        <div class="row ">
          <div class="col-lg-4 col-md-6 ">
            <div class="single_feature bg-warning">
              <div class="icon"><span class="flaticon-student"></span>
                <span class="text-primary">100</span>
              </div>
              <div class="desc">
                <h4 class="mt-3 mb-2">Total Semua Impian</h4>
                <p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_feature bg-warning">
              <div class="icon"><span class="flaticon-book"></span>
                <span class="text-primary">100</span>
              </div>
              <div class="desc">
                <h4 class="mt-3 mb-2">Impian Yang Belum Tercapai</h4>
                <p>
                  One make creepeth, man bearing theira firmament won't great
                  heaven
                </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_feature bg-warning">
              <div class="icon"><span class="flaticon-earth"></span>
                <span class="text-primary">100</span>
              </div>
              <div class="desc">
                <h4 class="mt-3 mb-2">Impian Yang Sudah Tercapai</h4>
                <p>
                  One make creepeth, man bearing theira firmament won't great
                  heaven
                </p>
            ...
            <div class="owl-carousel active_course">
              <div class="single_course">
                <div class="course_head">
                  <img class="img-fluid" src="/assetAdmin/img/courses/c1.jpg" alt="" />
                </div>
                <div class="course_content">
                  ...
                  >
                    <div class="authr_meta">
                      <img src="/assetAdmin/img/courses/author1.png" alt="" />
              ...
              <div class="single_course">
                <div class="course_head">
                  <img class="img-fluid" src="/assetAdmin/img/courses/c2.jpg" alt="" />
                </div>
                <div class="course_content">
                  <span class="price">$25</span>
                  <span class="tag mb-4 d-inline-block">design</span>
                  ...
                  >
                    <div class="authr_meta">
                      <img src="/assetAdmin/img/courses/author2.png" alt="" />
                      <span class="d-inline-block ml-2">Cameron</span>
                    </div>
                    <div class="mt-lg-0 mt-3">
                      <span class="meta_info mr-4">
              ...
              <div class="single_course">
                <div class="course_head">
                  <img class="img-fluid" src="/assetAdmin/img/courses/c3.jpg" alt="" />
                </div>
                <div class="course_content">
                  <span class="price">$25</span>
                  <span class="tag mb-4 d-inline-block">design</span>
                  ...
                  >
                    <div class="authr_meta">
                      <img src="/assetAdmin/img/courses/author3.png" alt="" />
                      <span class="d-inline-block ml-2">Cameron</span>
                    </div>
                    <div class="mt-lg-0 mt-3">
                      <span class="meta_info mr-4">
    ...
    <section class="trainer_area section_gap_top">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">Inspiration People</h2>
              <p>
                Berikut adalah orang yang dapat menginspirasi kita
              </p>
            </div>
          </div>
        </div>
        <div class="row justify-content-center d-flex align-items-center">
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src="/assetAdmin/img/trainer/t1.jpg" alt="" />
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src="/assetAdmin/img/trainer/t2.jpg" alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>David Cameron</h4>
              <p class="designation">Sr. web designer</p>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src="/assetAdmin/img/trainer/t3.jpg" alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>Jain Redmel</h4>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src="/assetAdmin/img/trainer/t4.jpg" alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>Nathan Macken</h4>
              <p class="designation">Sr. web designer</p>
